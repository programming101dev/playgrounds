...
The good path lives in `../../../examples/lib_error_examples/lifecycle/main.c`.
On GitHub: [lib_error_examples/lifecycle/main.c](https://github.com/programming101dev/lib_error_examples/blob/main/lifecycle/main.c).
