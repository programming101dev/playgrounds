...
The good path lives in `../../../examples/lib_fsm_examples/fsm_run/main.c`.
On GitHub: [lib_fsm_examples/fsm_run/main.c](https://github.com/programming101dev/lib_fsm_examples/blob/main/fsm_run/main.c).
