#!/usr/bin/env bash
# Build and run the standalone c-wide-classification playground track.
...
exec "${track_dir}/${build_dir}/p101-track-c-wide-classification" ${program_args[@]+"${program_args[@]}"}
