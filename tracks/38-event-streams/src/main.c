...
static const char *const wrapper_functions[] = {"p101_env_get_exit_tracer",    "p101_env_get_tracer",        "p101_env_get_tracer_data",
                                                "p101_env_set_call_log",       "p101_env_set_call_observer", "p101_env_set_exit_tracer",
                                                "p101_env_set_tracer",         "p101_env_set_tracer_data",   "p101_env_trace",
                                                ...
                                                "p101_env_enable_fd_tracking", "p101_env_report_leaks",      "p101_env_set_alloc_log",
                                                "p101_env_set_alloc_observer", "p101_env_set_fd_log",        "p101_env_set_fd_observer",
                                                "p101_env_track_alloc",        "p101_env_track_close",       "p101_env_track_exec",
                                                "p101_env_track_exec_failure", "p101_env_track_fork",        "p101_env_track_free",
                                                "p101_env_track_open",         "p101_env_track_realloc",     "p101_env_track_spawn"};
