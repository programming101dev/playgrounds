#!/usr/bin/env bash
# Build and run the standalone thread-synchronization playground track.
...
exec "${track_dir}/${build_dir}/p101-track-thread-synchronization" ${program_args[@]+"${program_args[@]}"}
