#!/usr/bin/env bash
# Build and run the standalone c-stdio-character-buffering playground track.
...
exec "${track_dir}/${build_dir}/p101-track-c-stdio-character-buffering" ${program_args[@]+"${program_args[@]}"}
