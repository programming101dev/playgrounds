...
The good path lives in `../../../examples/lib_endian_examples/round_trip/main.c`.
On GitHub: [lib_endian_examples/round_trip/main.c](https://github.com/programming101dev/lib_endian_examples/blob/main/round_trip/main.c).
