#!/usr/bin/env bash
# Build and run the standalone thread-state-cancellation playground track.
...
exec "${track_dir}/${build_dir}/p101-track-thread-state-cancellation" ${program_args[@]+"${program_args[@]}"}
