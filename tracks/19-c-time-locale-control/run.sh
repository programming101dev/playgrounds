#!/usr/bin/env bash
# Build and run the standalone c-time-locale-control playground track.
...
exec "${track_dir}/${build_dir}/p101-track-c-time-locale-control" ${program_args[@]+"${program_args[@]}"}
