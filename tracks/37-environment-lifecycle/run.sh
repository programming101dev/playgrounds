#!/usr/bin/env bash
# Build and run the standalone environment-lifecycle playground track.
...
exec "${track_dir}/${build_dir}/p101-track-environment-lifecycle" ${program_args[@]+"${program_args[@]}"}
