...
The good path lives in `../../../examples/lib_env_examples/env/get_tracer/main.c`.
On GitHub: [lib_env_examples/env/get_tracer/main.c](https://github.com/programming101dev/lib_env_examples/blob/main/env/get_tracer/main.c).
