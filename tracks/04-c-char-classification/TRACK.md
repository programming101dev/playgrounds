# Track 04: c-char-classification
...
The good path lives in `../../../examples/lib_c_examples/ctype/isalpha/main.c`.
On GitHub: [lib_c_examples/ctype/isalpha/main.c](https://github.com/programming101dev/lib_c_examples/blob/main/ctype/isalpha/main.c).
