#!/usr/bin/env bash
# Build and run the standalone c-char-classification playground track.
...
exec "${track_dir}/${build_dir}/p101-track-c-char-classification" ${program_args[@]+"${program_args[@]}"}
