#!/usr/bin/env bash
# Build and run the standalone c-complex-exp-log-power playground track.
...
exec "${track_dir}/${build_dir}/p101-track-c-complex-exp-log-power" ${program_args[@]+"${program_args[@]}"}
