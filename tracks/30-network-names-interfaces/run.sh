#!/usr/bin/env bash
# Build and run the standalone network-names-interfaces playground track.
...
exec "${track_dir}/${build_dir}/p101-track-network-names-interfaces" ${program_args[@]+"${program_args[@]}"}
