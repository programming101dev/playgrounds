...
The good path lives in `../../../examples/lib_c_examples/stdlib/abs/main.c`.
On GitHub: [lib_c_examples/stdlib/abs/main.c](https://github.com/programming101dev/lib_c_examples/blob/main/stdlib/abs/main.c).
